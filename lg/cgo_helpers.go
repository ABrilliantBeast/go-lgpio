...
// allocLgGpioAlertMemory allocates memory for type C.lgGpioAlert_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocLgGpioAlertMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfLgGpioAlertValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfLgGpioAlertValue = unsafe.Sizeof([1]C.lgGpioAlert_t{})

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *LgGpioAlert) Ref() *C.lgGpioAlert_t {
	if x == nil {
		return nil
	}
	return x.ref3dbb948
...
// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *LgGpioAlert) Free() {
	if x != nil && x.allocs3dbb948 != nil {
		x.allocs3dbb948.(*cgoAllocMap).Free()
		x.ref3dbb948 = nil
	}
}

// NewLgGpioAlertRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewLgGpioAlertRef(ref unsafe.Pointer) *LgGpioAlert {
	if ref == nil {
		return nil
	}
	obj := new(LgGpioAlert)
	obj.ref3dbb948 = (*C.lgGpioAlert_t)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *LgGpioAlert) PassRef() (*C.lgGpioAlert_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref3dbb948 != nil {
		return x.ref3dbb948, nil
	}
	mem3dbb948 := allocLgGpioAlertMemory(1)
	ref3dbb948 := (*C.lgGpioAlert_t)(mem3dbb948)
	allocs3dbb948 := new(cgoAllocMap)
	allocs3dbb948.Add(mem3dbb948)

	var creport_allocs *cgoAllocMap
	ref3dbb948.report, creport_allocs = x.Report.PassValue()
	allocs3dbb948.Borrow(creport_allocs)

	var cnfyHandle_allocs *cgoAllocMap
	ref3dbb948.nfyHandle, cnfyHandle_allocs = (C.int)(x.NfyHandle), cgoAllocsUnknown
	allocs3dbb948.Borrow(cnfyHandle_allocs)

	x.ref3dbb948 = ref3dbb948
	x.allocs3dbb948 = allocs3dbb948
	return ref3dbb948, allocs3dbb948

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x LgGpioAlert) PassValue() (C.lgGpioAlert_t, *cgoAllocMap) {
	if x.ref3dbb948 != nil {
		return *x.ref3dbb948, nil
	}
	ref, allocs := x.PassRef()
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *LgGpioAlert) Deref() {
	if x.ref3dbb948 == nil {
		return
	}
	x.Report = *NewLgGpioReportRef(unsafe.Pointer(&x.ref3dbb948.report))
	x.NfyHandle = (int32)(x.ref3dbb948.nfyHandle)
}
...
// packSLgGpioAlert reads sliced Go data structure out from plain C format.
func packSLgGpioAlert(v []LgGpioAlert, ptr0 *C.struct_lgGpioAlert_s) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfStruct_lgGpioAlertValue]C.struct_lgGpioAlert_s)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewLgGpioAlertRef(unsafe.Pointer(&ptr1))
	}
}

func (x LgGpioAlertsFunc) PassRef() (ref *C.lgGpioAlertsFunc_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if lgGpioAlertsFuncEF94F791Func == nil {
		lgGpioAlertsFuncEF94F791Func = x
	}
	return (*C.lgGpioAlertsFunc_t)(C.lgGpioAlertsFunc_t_ef94f791), nil
}

func (x LgGpioAlertsFunc) PassValue() (ref C.lgGpioAlertsFunc_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if lgGpioAlertsFuncEF94F791Func == nil {
...
func NewLgGpioAlertsFuncRef(ref unsafe.Pointer) *LgGpioAlertsFunc {
	return (*LgGpioAlertsFunc)(ref)
}

//export lgGpioAlertsFuncEF94F791
func lgGpioAlertsFuncEF94F791(cnum_alerts C.int, calerts *C.struct_lgGpioAlert_s, cuserdata unsafe.Pointer) {
	if lgGpioAlertsFuncEF94F791Func != nil {
		num_alertsef94f791 := (int32)(cnum_alerts)
		var alertsef94f791 []LgGpioAlert
		packSLgGpioAlert(alertsef94f791, calerts)
		userdataef94f791 := (unsafe.Pointer)(unsafe.Pointer(cuserdata))
		lgGpioAlertsFuncEF94F791Func(num_alertsef94f791, alertsef94f791, userdataef94f791)
		return
	}
	panic("callback func has not been set (race?)")
}

var lgGpioAlertsFuncEF94F791Func LgGpioAlertsFunc
